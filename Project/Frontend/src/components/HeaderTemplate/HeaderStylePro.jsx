...
const HeaderStylePro = ({ cardStyle, setCardStyle }) => {
  ...
  return (
    <div className="bg-white p-4 overflow-y-auto max-h-[34rem] h-[35rem] rounded-lg border border-b-slate-50 transition-all ease-in-out delay-300 ">
      <strong>
      ...
      <div className="p-4">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col">
            <h2 className="text-left gap-2 font-semibold">Mix </h2>
            <div className="flex flex-col justify-start items-start gap-3">
              ...
              <div className="flex gap-2 ">
                <Button
                  className="flex-1"
                  onClick={() =>
                    handleHeadingCaseChange({ target: { value: "uppercase" } })
                  }
                >
                  <h2> UPPERCASE </h2>
                </Button>
                <Button
                  className="flex-1"
                  onClick={() =>
                    handleHeadingCaseChange({ target: { value: "lowercase" } })
                  }
                >
                  <h2> lowercase </h2>
                </Button>
                <Button
                  className="flex-1"
                  onClick={() =>
                    handleHeadingCaseChange({ target: { value: "capitalize" } })
                  }
                >
                  <h2> Camelcase </h2>
                </Button>
